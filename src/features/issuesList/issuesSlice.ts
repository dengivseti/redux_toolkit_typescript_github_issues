...
const issues = createSlice({
    ...
    reducers: {
        ...
        getIssuesSuccess(state, {payload}: PayloadAction<IssuesResult>) {
            const {issues, pageCount, pageLinks} = payload
...
export const {getIssuesStart, getIssueSuccess,  getIssueStart, getIssuesSuccess, getIssueFailure, getIssuesFailure} = issues.actions
...
export const fetchIssues = (
    ...
    try {
        ...
        dispatch(getIssuesFailure(e.toString()))
    }
}
...
export const fetchIssue = (
    ...
    try {
        ...
        dispatch(getIssueFailure(e.toString()))
    }
}